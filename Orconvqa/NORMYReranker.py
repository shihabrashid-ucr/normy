...
with open('history_models/orconvqa/normy_retr.json') as f:
    dial = json.load(f)

tokenizer = AutoTokenizer.from_pretrained("amberoad/bert-multilingual-passage-reranking-msmarco") # MSMARCO trained model
...
for d in range(0, len(dial)):
    ...
    outermostlist.append(innerjson)
with open('history_models/orconvqa/normy_reranker.json', 'w') as outfile:
